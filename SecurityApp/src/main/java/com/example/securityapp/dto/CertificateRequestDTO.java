...
public class CertificateRequestDTO {
        ...
        public int issuerId;         // ID CA sertifikata koji potpisuje
        ...
        public CertificateRequestDTO(String subject, int issuerId, int durationInDays, boolean isCA, Map<String, String> extensions) {
